...
export abstract class PalettePropertyChange<T> extends ThemingPropertyChangeEvent<Palette, T> { }
...
export type PaletteChanges = PaletteCssChange | PaletteColorChange | PaletteContrastColorChange;
